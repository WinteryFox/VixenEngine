...
namespace graphics {
    ...
    public:
        ...
        objects::entity::Entity *addEntity(Mesh *mesh, vec3 position = vec3(0.0f), vec3 rotation = vec3(0.0f), float scale = 1.0f);
    
        objects::entity::Entity *
        addEntity(model::Model *model, vec3 position = vec3(0.0f), vec3 rotation = vec3(0.0f), float scale = 1.0f);
